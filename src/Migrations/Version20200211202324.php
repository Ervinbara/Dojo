 ...
 */
final class Version20200211202324 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE messages DROP to_id_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE messages ADD to_id_id INT DEFAULT NULL');
